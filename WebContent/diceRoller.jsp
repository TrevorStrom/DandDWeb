...
<body>
	...
	<section id="mainContent">
		<h1>Dice Roller</h1>
		<form id="Player1">
			<div class="charSheet" id="dieRoll">
				<div class="dieRollInput">
					<div class="labelDiv"><label>Die type:</label></div> <div class="inputDiv"><select id="die_type">
						<option>D2</option>
						<option>D3</option>
						<option>D4</option>
						<option>D6</option>
					...
					<div class="labelDiv"><label>Number of dice:</label></div>
					<div class="inputDiv"><select id="die_number">
						<option>1</option>
						<option>2</option>
						<option>3</option>
						<option>4</option>
			...
			<div class="charSheet" id="dieRollOutput">
